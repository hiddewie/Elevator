...
class PersonArrived(@field:TargetAggregateIdentifier
                    val personId: PersonId, val floor: Long, val requestedFloor: Long)
...
class PersonArrivedAtFloor(@field:TargetAggregateIdentifier
                           val personId: PersonId, val floor: Long)
